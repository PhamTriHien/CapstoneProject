        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // Convert Vector4[] UVs to Vector2[] for mesh.uv4
                    Vector4[] sourceUV4 = textInfo.meshInfo[i].uvs0;
                    Vector2[] destUV4 = new Vector2[sourceUV4.Length];
                    for (int j = 0; j < sourceUV4.Length; j++)
                        destUV4[j] = new Vector2(sourceUV4[j].x, sourceUV4[j].y);
                    textInfo.meshInfo[i].mesh.uv4 = destUV4;
